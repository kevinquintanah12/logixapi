...
import chofer.schema
import rutas.schema
class Query(users.schema.Query, rutas.schema.Query, camiones.schema.Query, entrega.schema.Query,  paquete.schema.Query, producto.schema.Query, destinatario.schema.Query,cliente.schema.Query, chofer.schema.Query, horarios.schema.Query, centrodistribucion.schema.Query, roles_y_permisos.schema.Query, tipoproductos.schema.Query, Ubicacion.schema.Query,calcularenvio.schema.Query,graphene.ObjectType):
    pass
