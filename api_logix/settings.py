"""
Django settings for api_logix project.
...
SECRET_KEY = 'django-insecure-mv8+u+x50r@uf5_1*!@3iu$n5g%6=e#30f(ttyo)#dh+cu!dd&'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'logix_db',       # Nombre de tu base de datos
...
GRAPHENE = {
    'SCHEMA': 'api_logix.schema.schema',
    'MIDDLEWARE': [
